...
public class Silly implements Comparable<Silly>{
    ...
    /** Creates a new silly object, this constructor takes in two strings as an argument and sets the name
    of this object to a concatenation of both these strings */
